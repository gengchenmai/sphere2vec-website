...
This is the repository that contains source code for the [Sphere2Vec website](https://gengchenmai.github.io/sphere2vec-website/).

If you find Sphere2Vec useful for your work please cite:
```
